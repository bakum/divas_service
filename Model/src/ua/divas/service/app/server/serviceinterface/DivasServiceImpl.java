...
public class DivasServiceImpl extends ServiceImpl implements DivasService {
     ...
     */
    public KassaSettingsViewSDO getKassaSettingsView1(String id) throws ServiceException {
        return (KassaSettingsViewSDO) get(new Object[] { id }, "KassaSettingsView1", KassaSettingsViewSDO.class);
    }
     ...
     */
    public OrderStatusViewSDO getOrderStatusView1(String id) throws ServiceException {
        return (OrderStatusViewSDO) get(new Object[] { id }, "OrderStatusView1", OrderStatusViewSDO.class);
    }
